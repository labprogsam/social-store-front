...
const categoriesData = [
  { id: 1, image: categoria1, name: "Artesanato e Produtos", items: 55 },
  { id: 2, image: categoria2, name: "Alimentos e Bebidas", items: 55 },
  { id: 3, image: categoria3, name: "Roupas e Acessórios", items: 55 },
  { id: 4, image: categoria4, name: "Arte e Cultura", items: 55 },
  { id: 5, image: categoria5, name: "Produtos Sustentáveis", items: 55 },
  { id: 6, image: categoria6, name: "Produtos de Higiene e Cosméticos Naturais", items: 55 },
  { id: 7, image: categoria7, name: "Itens de Decoração", items: 55 },
